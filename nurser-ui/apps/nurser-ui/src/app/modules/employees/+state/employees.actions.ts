...
export const loadEntities = createAction(EmployeesActionTypes.LoadEntities, props<{ payload: ODataGridState }>());
...
export const addEditCertification = createAction(EmployeesActionTypes.AddEditCertification, props<{ payload: { employee: IEmployee, certification: IEmployeeCertification } }>());
export const clearCurrentCertification = createAction(EmployeesActionTypes.ClearCurrentCertification);
export const saveCertificationRequest = createAction(EmployeesActionTypes.SaveCertificationRequest, props<{ payload: IEmployee }>());
export const saveCertificationSuccess = createAction(EmployeesActionTypes.SaveCertificationSuccess, props<{ payload: IEmployee }>());
