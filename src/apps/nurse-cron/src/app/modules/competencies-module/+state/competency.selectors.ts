...
import { COMPETENCIES_FEATURE_KEY, State } from './competency.reducer';
import { isTruthy } from 'imng-ngrx-utils';

export const getCompetenciesState = createFeatureSelector<State>(COMPETENCIES_FEATURE_KEY);
...
const getCurrentCompetency = createSelector(getCompetenciesState, (state) => state.currentCompetency);
