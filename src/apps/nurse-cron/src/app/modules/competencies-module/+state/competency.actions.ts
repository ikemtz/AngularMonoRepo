...
export const loadCompetenciesRequest = createPayloadAction<ODataState>('[Competencies] Load Competencies Request');
export const loadCompetenciesSuccess = createPayloadAction<ODataResult<ICompetency>>(
  '[Competencies] Load Competencies Success',
);
export const reloadCompetenciesRequest = createAction('[Competencies] Reload Competencies Request');
