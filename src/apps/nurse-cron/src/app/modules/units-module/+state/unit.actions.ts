...
export const loadUnitsRequest = createPayloadAction<ODataState>('[Units] Load Units Request');
export const loadUnitsSuccess = createPayloadAction<ODataResult<IUnit>>('[Units] Load Units Success');
export const reloadUnitsRequest = createAction('[Units] Reload Units Request');
export const reloadUnitsSuccess = createPayloadAction<ODataResult<IUnit>>('[Units] Reload Units Success');
