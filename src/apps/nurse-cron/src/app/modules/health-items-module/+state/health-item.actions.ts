...
export const loadHealthItemsRequest = createPayloadAction<ODataState>('[HealthItems] Load HealthItems Request');
export const loadHealthItemsSuccess = createPayloadAction<ODataResult<IHealthItem>>(
  '[HealthItems] Load HealthItems Success',
);
export const reloadHealthItemsRequest = createAction('[HealthItems] Reload HealthItems Request');
