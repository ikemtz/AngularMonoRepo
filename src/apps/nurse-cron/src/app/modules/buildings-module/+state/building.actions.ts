...
export const loadBuildingsRequest = createPayloadAction<ODataState>('[Buildings] Load Buildings Request');
export const loadBuildingsSuccess = createPayloadAction<ODataResult<IBuilding>>('[Buildings] Load Buildings Success');
export const reloadBuildingsRequest = createAction('[Buildings] Reload Buildings Request');
