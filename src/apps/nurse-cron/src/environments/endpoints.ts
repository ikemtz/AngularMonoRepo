export const endPoints = {
    buildings: {
        buildingsOData: 'buildings-odata/odata/v1/Buildings',
        buildingsApi: 'buildings-webapi/api/v1/Buildings.json',
    },
    certifications: {
    ...
    competencies: {
        competenciesOData: 'competencies-odata/odata/v1/Competencies',
        competenciesApi: 'competencies-webapi/api/v1/Competencies.json',
    },
    employees: {
