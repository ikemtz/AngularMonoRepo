...
export class IMNG_KENDO_DRAWER_STUB {//NOSONAR
 ...
 @Output() public expand?: EventEmitter<unknown>;
 @Output() public collapse?: EventEmitter<unknown>;
 // eslint-disable-next-line @angular-eslint/no-output-native
 @Output() public select?: EventEmitter<unknown>;
