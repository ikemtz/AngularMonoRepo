...
export class FilterOperators {
  ...
  public static readonly equals: IFilterOperator = {
    name: 'equals',
    toODataString: (field: string, isRelativeValue: boolean, value?: IdType) =>
      serializeSimpleFilter(field, 'eq', isRelativeValue, value),
  };
  /**
   * The `gt` operator.
   */
  public static readonly greaterThan: IFilterOperator = {
    ...
    toODataString: (
      ...
      value?: IdType,
    ): string => serializeSimpleFilter(field, 'gt', isRelativeValue, value),
  };
  /**
   * The `ge` operator.
   */
  public static readonly greaterThanOrEquals: IFilterOperator = {
    ...
    toODataString: (
      ...
      isRelativeValue: boolean,
      value?: IdType,
    ): string => serializeSimpleFilter(field, 'ge', isRelativeValue, value),
  };
  /**
   * The `lt` operator.
   */
  public static readonly lessThan: IFilterOperator = {
    ...
    toODataString: (
      ...
      isRelativeValue: boolean,
      value?: IdType,
    ): string => serializeSimpleFilter(field, 'lt', isRelativeValue, value),
  };
  /**
   * The `le` operator.
   */
  public static readonly lessThanOrEquals: IFilterOperator = {
    ...
    toODataString: (
      ...
      isRelativeValue: boolean,
      value?: IdType,
    ): string => serializeSimpleFilter(field, 'le', isRelativeValue, value),
  };
  /**
   * The `ne` operator.
   */
  public static readonly notEquals: IFilterOperator = {
    ...
    toODataString: (
      ...
      isRelativeValue: boolean,
      value?: IdType,
    ): string => serializeSimpleFilter(field, 'ne', isRelativeValue, value),
  };
  /**
   * The `in` operator.
   */
  public static readonly in: IFilterOperator = {
    ...
    toODataString: (
      ...
      isRelativeValue: boolean,
      values?: IdType[],
    ): string => serializeArrayFilter(field, 'in', isRelativeValue, values),
  };
  /**
   * The `not in` operator.
   */
  public static readonly notIn: IFilterOperator = {
    ...
    toODataString: (
      ...
      isRelativeValue: boolean,
      values?: IdType[],
    ): string => serializeArrayFilter(field, 'not in', isRelativeValue, values),
  };
  /**
  ...
  public static readonly contains: IFilterOperator = {
    ...
    toODataString: (
      ...
      serializeFunctionFilter(field, 'contains', isRelativeValue, value),
  };
  /**
  ...
  public static readonly notContains: IFilterOperator = {
    ...
    toODataString: (
      ...
      serializeFunctionFilter(field, 'not contains', isRelativeValue, value),
  };
  /**
  ...
  public static readonly endsWith: IFilterOperator = {
    ...
    toODataString: (
      ...
      serializeFunctionFilter(field, 'endswith', isRelativeValue, value),
  };
  /**
  ...
  public static readonly notEndsWith: IFilterOperator = {
    ...
    toODataString: (
      ...
      serializeFunctionFilter(field, 'not endswith', isRelativeValue, value),
  };
  /**
  ...
  public static readonly startsWith: IFilterOperator = {
    ...
    toODataString: (
      ...
      serializeFunctionFilter(field, 'startswith', isRelativeValue, value),
  };
  /**
  ...
  public static readonly notStartsWith: IFilterOperator = {
    ...
    toODataString: (
      ...
      serializeFunctionFilter(field, 'not startswith', isRelativeValue, value),
  };
  /**
   * The `empty` operator.
   */
