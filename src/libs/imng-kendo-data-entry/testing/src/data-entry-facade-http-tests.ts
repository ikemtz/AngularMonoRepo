...
export async function testSaveCurrentEntity<TFacade extends IDataEntryFacade<unknown>>(
...
export async function testUpdateCurrentEntity<TFacade extends IDataEntryFacade<unknown>>(
  done: jest.DoneCallback,
  facade: TFacade,
  httpClient: HttpClient,
) {
